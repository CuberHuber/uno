        ...
        <div className="lp-hero-in">
          <div className="lp-hero-copy">
            ...
            <div className="lp-ctas" ref={ctaRef}>
              <button className="btn btn-primary btn-big" onClick={cta('hero', () => setCreating(true))}>
                {t('landing.create')}
              </button>
      ...
      <section className="lp-close">
        <div className="lp-close-in">
          ...
          <button className="btn btn-big" style={{ marginTop: 32, background: '#fffdf8', color: 'var(--color-text)' }}
            onClick={cta('close', () => setCreating(true))}>{t('landing.create')}</button>
        </div>
      </section>
          ...
          {!joinOpen ? (
            <div className="lp-bar-row">
              <button className="btn btn-primary" style={{ flex: 1, minHeight: 46 }}
                onClick={cta('bar', () => setCreating(true))}>{t('landing.create')}</button>
