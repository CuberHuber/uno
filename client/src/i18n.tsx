...
const DICT = {
  en: {
    ...
    'sound.open': 'Sound', 'sound.title': 'Sound',
    'sound.sfx': 'Effects', 'sound.sfxHint': 'Cards, draws, the call and the catch',
    'sound.music': 'Music', 'sound.musicHint': 'The quiet bed under the table',
    'sound.musicLevel': 'Music level',
    'moves.title': 'Moves', 'moves.open': 'Moves',
    'moves.kept': '{n} of 200 kept',
    'moves.empty': 'Nothing has happened yet.',
    'moves.trimmed': 'Earlier moves are gone — the room keeps the last 200.',
  ...
  ru: {
    ...
    'sound.open': 'Звук', 'sound.title': 'Звук',
    'sound.sfx': 'Эффекты', 'sound.sfxHint': 'Карты, добор, объявление и поимка',
    'sound.music': 'Музыка', 'sound.musicHint': 'Тихий фон за столом',
    'sound.musicLevel': 'Громкость музыки',
    'moves.title': 'Ходы', 'moves.open': 'Ходы',
    'moves.kept': '{n} из 200',
    'moves.empty': 'Пока ничего не произошло.',
    'moves.trimmed': 'Ранние ходы стёрты — комната хранит последние 200.',
